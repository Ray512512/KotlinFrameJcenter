...
import common.presentation.navigation.Navigator
import common.presentation.utils.IntentUtils
import common.presentation.utils.S
import common.presentation.utils.StatusBarUtils
import common.presentation.utils.ViewUtils
import common.presentation.widget.impl.LayoutAnim
import common.view.dialog.LoadingDialog
import common.view.viewhelper.VaryViewHelper
...
/*
    val activityComponent:BaseActivityComponent by unSafeLazy {
        DI().plus(ActivityModule(this))
    }*/
...
//    public fun DI() = BaseApp.instance.baseAppComponent
