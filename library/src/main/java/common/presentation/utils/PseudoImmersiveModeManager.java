...
public class PseudoImmersiveModeManager {
    ...
    private int statusBarColorBefore23 = ContextCompat.getColor(BaseApp.instance,R.color.mainColor); // [4.4-6.0) 的背景颜色
    ...
    private Drawable drawable = ContextCompat.getDrawable(BaseApp.instance, R.drawable.shape_gradient);
