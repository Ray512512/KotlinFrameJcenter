...
public class SPUtils {
    ...
    private static final String KEY = BaseApp.instance.getPackageName() + ".spkey";
    private static  String KEY_USER =KEY;
    private static SharedPreferences mPreferences;

    private static SharedPreferences getmPreferences() {
        if (mPreferences == null) {
            mPreferences = BaseApp.instance.getSharedPreferences(KEY_USER, Context.MODE_PRIVATE);
        }
        return mPreferences;
    }

    public static SharedPreferences getCommonSp() {
        return BaseApp.instance.getSharedPreferences(KEY, Context.MODE_PRIVATE);
    }
