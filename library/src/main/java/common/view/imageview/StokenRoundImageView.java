...
public class StokenRoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        TypedArray a = mContext.obtainStyledAttributes(attrs,
                R.styleable.StokenRoundImageView);
  
        mBorderThickness = a.getDimensionPixelSize(  
                R.styleable.StokenRoundImageView_border_thickness, 0);
  
        mBorderOutsideColor = a  
                .getColor(R.styleable.StokenRoundImageView_border_outside_color,
                        defaultColor);  
  
        mBorderInsideColor = a.getColor(  
                R.styleable.StokenRoundImageView_border_inside_color, defaultColor);
