...
public class AlineLinerlayoutView extends LinearLayout {
    ...
    public AlineLinerlayoutView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.AlineLinerlayoutView, 0, 0);
        try {
            name = ta.getString(R.styleable.AlineLinerlayoutView_name);
            content = ta.getString(R.styleable.AlineLinerlayoutView_lv_content);
            isBottom = ta.getBoolean(R.styleable.AlineLinerlayoutView_isBottom, false);
            isSpacing = ta.getBoolean(R.styleable.AlineLinerlayoutView_isSpaceing, false);
            canNav = ta.getBoolean(R.styleable.AlineLinerlayoutView_canNav,false);
            isSwitch = ta.getBoolean(R.styleable.AlineLinerlayoutView_isSwitch,false);
            image = ta.getResourceId(R.styleable.AlineLinerlayoutView_image,0);
            isAllLine = ta.getBoolean(R.styleable.AlineLinerlayoutView_isAllLine,false);
            setUpView();
        } finally {
            ta.recycle();
        }
